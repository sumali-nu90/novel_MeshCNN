...
class VertexMeshUnion:
    ...
    def get_group(self, vertex_key):
        return self.groups[vertex_key, :]
    ...
    def rebuild_features_average(self, features, mask, target_vertices):
        ...
        fe = fe / occurrences
        padding_b = target_vertices - fe.shape[1]
        if padding_b > 0:
